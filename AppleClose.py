...
# https://www.youtube.com/watch?v=QIUxPv5PJOY&list=WL&index=20&t=1563s
...
#Here I am setting the path of my Apple Dataset and storing it in appleData variable
appleData = pd.read_csv(r'D:/4th Year/Final Year Project/Mid-Implementation/NewYork Stock Exchange/Apple.csv')
...
#Visualize the data
plt.figure(figsize=(16,8))
plt.title('Apple closing prediction')
plt.xlabel('Date', fontsize=18)
...
apple_quote=web.DataReader('AAPL', data_source='yahoo', start='2015-01-01', end='2020-12-25')
...
print(pred_price)#123.5206 (2020-12-25)

apple_quote2=web.DataReader('AAPL', data_source='yahoo', start='2015-01-01', end='2020-12-28')
...
print(second_pred_price)#124.61107(2020-12-28)

apple_quote3=web.DataReader('AAPL', data_source='yahoo', start='2015-01-01', end='2021-01-05')
new_df3=apple_quote3.filter(['Close'])
...
print(third_pred_price)#124.642265(2021-01-05)

apple_quote4=web.DataReader('AAPL', data_source='yahoo', start='2015-01-01', end='2021-01-10')
new_df4=apple_quote4.filter(['Close'])
...
print(fourth_pred_price)#123.00415(2021-01-10)

apple_quote5=web.DataReader('AAPL', data_source='yahoo', start='2015-01-01', end='2021-01-15')
new_df5=apple_quote5.filter(['Close'])
...
print(fifth_pred_price)#121.85197(2021-01-15)
