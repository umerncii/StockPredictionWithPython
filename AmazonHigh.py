...
plt.title('Amazon High Stock price')
plt.plot(amznData['High'])
plt.xlabel('Date', fontsize=16)
plt.ylabel('Amazon high stock prices in USD $', fontsize=16)
plt.show()
#Creating a new dataframe with only our high stock column
data = amznData.filter(['High'])
...
plt.title('Amazon High stock price Prediction')
plt.xlabel('Days 2010-2020', fontsize=18)
plt.ylabel('High stock price in $', fontsize=16)
plt.plot(train['High'])
...
print(fifth_pred_price)#2997.8108(2021-01-15)
